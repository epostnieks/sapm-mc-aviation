#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Aviation Emissions / Altitude Forcing Floor
===========================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Aviation Emissions (Altitude Forcing Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "aviation",
    "domain_name": "Aviation Emissions",
    "theorem": "Altitude Forcing Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 100.0,
    "channels": {
        "C1_co2_climate_damage": {
            ...
            "high": 323.4,
            "weight": 0.35,
            "description": "CO\u2082 emissions ~1Gt/yr at EPA SCC $190/t. 2.5% of global emissions. Sources: EPA, ICAO, Lee et al. 2021."
        },
        "C2_non_co2_climate": {
            "dist": "lognormal",
            "low": 67.4,
            ...
            "high": 202.1,
            "weight": 0.25,
            "description": "Contrails, NOx, aerosols. Effective radiative forcing 2-4\u00d7 CO\u2082 alone. Lee et al. 2021 Nature. Sources: Lee et al. 2021, IPCC AR6."
        },
        "C3_air_quality_mortality": {
            ...
            "high": 117.6,
            "weight": 0.2,
            "description": "Airport and flight-path PM2.5/NOx mortality. 16,000 deaths/yr (Yim et al. 2015). Sources: Yim et al., Masiol & Harrison, EPA."
        },
        "C4_community_noise": {
            "dist": "lognormal",
            "low": 27.0,
            ...
            "high": 80.8,
            "weight": 0.1,
            "description": "Aircraft noise health impacts: CVD, sleep disruption, cognitive impairment in children. 2M+ affected near major airports. Sources: WHO, Basner et al., FAA."
        },
        "C5_governance_capture": {
            ...
            "high": 40.4,
            "weight": 0.1,
            "description": "ICAO industry capture, CORSIA offsetting loophole, Annex 16 inadequacy. $35B/yr in foregone fuel tax. Sources: ICAO, T&E, ICCT."
        }
    },
    "impossibility_floor": 2.7
}
